 ...
 *
 */
public class CountTasksEmAndamentoProvider {

	public String countEmAndamento(Map<String, Object> parameters) throws SQLBuilderException {
		...
		stmt += "WHERE 1=1 ";
		stmt += "AND I.TYPE_ = 'candidate' AND RES.ASSIGNEE_ IS NOT NULL ";
