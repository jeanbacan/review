...
import br.com.vivo.bcm.business.dao.IJPABaseDAO;
 ...
 */
public abstract class JPABaseDAO<B extends Serializable, T extends IUID<B>> extends BaseDAO<B, T> implements IJPABaseDAO<B, T> {

	private static Logger logger = Logger.getLogger(JPABaseDAO.class);
	...
	public JPABaseDAO() {
		this.entityClass = (Class<T>) TypeUtils.getRawType(JPABaseDAO.class.getTypeParameters()[1], this.getClass());
	}
