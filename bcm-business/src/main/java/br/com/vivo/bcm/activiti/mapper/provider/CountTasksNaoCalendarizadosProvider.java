 ...
 *
 */
public class CountTasksNaoCalendarizadosProvider {

	private static final Logger logger = Logger.getLogger(CountTasksNaoCalendarizadosProvider.class);
	
	public String countNaoCalendarizados(Map<String, Object> parameters) throws SQLBuilderException {
