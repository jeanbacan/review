 ...
 *
 */
public class CountTasksReprovadosProvider {

	private static final Logger logger = Logger.getLogger(CountTasksReprovadosProvider.class);
	
	public String countReprovados(Map<String, Object> parameters) throws SQLBuilderException {
