 ...
 *
 */
public class CountTasksObrasConcluidasProvider {

	private static final Logger logger = Logger.getLogger(CountTasksObrasConcluidasProvider.class);
	
	public String countObrasConcluidas(Map<String, Object> parameters) throws SQLBuilderException {
